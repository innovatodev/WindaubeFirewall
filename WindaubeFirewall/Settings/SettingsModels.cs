...
public class NetworkActionSettings
{
    ...
    public int DefaultNetworkAction { get; set; } = 1;
    public bool ForceBlockInternet { get; set; } = false;
    public bool ForceBlockLAN { get; set; } = false;
    public bool ForceBlockLocalhost { get; set; } = false;
    public bool ForceBlockIncoming { get; set; } = true;
    public bool BlockBypassDNS { get; set; } = true;
    public List<string> IncomingRules { get; set; } = [];
    public List<string> OutgoingRules { get; set; } = [];
}
...
public class SettingsProfiles : SettingsBase
{
    ...
    public NetworkActionSettings NetworkAction { get; set; } = new();
    public BlocklistsSettings Blocklists { get; set; } = new();
}
